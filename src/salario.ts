...
export class Salario {
   ...
   */
  public _salarioBruto: number;
  public _baseINSS: number;
  public _descontoINSS: number;
  public _baseIRPF: number;
  public _descontoIRPF: number;
  public _salarioLiquido: number;
